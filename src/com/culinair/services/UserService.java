...
public class UserService {
    ...
    private User getOne() {
        try {
            ...
            return new User(
                    ...
                    new SimpleDateFormat("dd-MM-yyyy").parse((String) obj.get("naissance")),
    ...
    public int manage(User user, boolean isEdit, boolean imageEdited) {
        ...
        cr.addArgumentNoEncoding("naissance", new SimpleDateFormat("dd-MM-yyyy").format(user.getNaissance()));
        cr.addArgumentNoEncoding("image", user.getImage());
