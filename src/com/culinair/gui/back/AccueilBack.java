...
public class AccueilBack extends Form {
    ...
    public static AccueilBack accueilForm;

    public AccueilBack(Resources theme) {
        super("Accueil");
        accueilForm = this;
        ...
        addComponentAndRefresh(
                new com.culinair.gui.back.user.DisplayAll().addGUIs(),
                "Utilisateurs"
        );

        t.addMaterialCommandToSideMenu("Utilisateurs  ", FontImage.MATERIAL_PERSON, (l) -> {
            addComponentAndRefresh(
                    new com.culinair.gui.back.user.DisplayAll().addGUIs(),
                    "Utilisateurs"
            );
